...
$$
\int_{x_{i-1}}^{x_{i}}f(x)dx \simeq h\left(\frac{1}{2}f_{i-1}+\frac{1}{2}f_{i}\right)\qqaud(h = x_{i}-x_{i-1}, i = 1, 2, \cdots, N)
$$
...
4. 
$$
\int_{x_{0}}^{x_{2}}f(x)dx \simeq h\left(\frac{1}{3}f_{0}+\frac{4}{3}f_{1}+\frac{1}{3}f_{2}\right)
$$
