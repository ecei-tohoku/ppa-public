...
- まず初期化式1にしたがって初期化
- 条件式2が真であれば`for`文の中の文の処理を行い、変化式3の処理を行う
...
- i=0は条件i<4を満たすので、xにi=0を足してx=0、iに1を足してi=1
- i=1は条件i<4を満たすので、xにi=1を足してx=1、iに1を足してi=2
- i=2は条件i<4を満たすが、`if`文の条件i=2を満たすので、`break`文により`for`を強制終了、最終的なxの値はx=1
...
- i=0は条件i<4を満たすので、xにi=0を足してx=0、iに1を足してi=1
- i=1は条件i<4を満たすので、xにi=1を足してx=1、iに1を足してi=2
- i=2は条件i<4を満たすので、xにi=2を足してx=3、さらに`if`文の条件i=2を満たすので、`break`文により`for`を強制終了、最終的なxの値はx=3
