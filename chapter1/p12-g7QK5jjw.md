...
- i=0は条件i<4を満たすので、xに1を足してx=1
- i=1は条件i<4を満たすので、xに1を足してx=2
- i=2は条件i<4を満たすので、xに1を足してx=3
- i=3は条件i<4を満たすので、xに1を足してx=4
...
この場合、次のように動作する。
- i=0は条件i<4を満たすので、xにi=0を足してx=0
- i=1は条件i<4を満たすので、xにi=1を足してx=1
- i=2は条件i<4を満たすので、xにi=2を足してx=3
- i=3は条件i<4を満たすので、xに1=3を足してx=6
