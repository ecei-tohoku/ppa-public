...
- $i=4$は条件$i<4$を満たさないので、`for`文を終了、最終的な値は$x=4,i=4$
...
- $i=4$は条件$i<4$を満たさないので、`for`文を終了、最終的な値は$x=6,i=4$
...
- $x=3$は条件$x<3$を満たさないので、`while`文は終了、最終的な値は$x=3$
...
- $i=0$は条件$i<4$を満たすので、$x$に$i=0$を足して$x=0$、$i$に$1$を足して$i=1$
- $i=1$は条件$i<4$を満たすので、$x$に$i=1$を足して$x=1$、$i$に$1$を足して$i=2$
- $i=2$は条件$i<4$を満たすが、`if`文の条件$i=2$を満たすので、`break`文により`for`文を強制終了、最終的な値は$x=1,i=2$
...
- $i=0$は条件$i<4$を満たすので、$x$に$i=0$を足して$x=0$、$i$に$1$を足して$i=1$
- $i=1$は条件$i<4$を満たすので、$x$に$i=1$を足して$x=1$、$i$に$1$を足して$i=2$
- $i=2$は条件$i<4$を満たすので、$x$に$i=2$を足して$x=3$、さらに`if`文の条件$i=2$を満たすので、`break`文により`for`文を強制終了、最終的な値は$x=3,i=2$
