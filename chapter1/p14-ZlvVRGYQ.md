...
- 要素数20の文字配列を確保し，`"I am fine.\n"`という文字列を`fgets(str, 20, stdin)`で読み込んだとき，ヌル文字を含めた文字配列の中身は以下のようになっている：

<div align="left">
<img src="p14-string.png" width="1200px">
</div>

  - 繰り返しになるが，ヌル文字は文字列の末尾`str[11]`に追加されている．
  - 文字列長が20よりも大きいとき，先頭の19文字がstr`str[0]`から`str[18]`までに格納され，`str[19]`にはヌル文字が格納される．
