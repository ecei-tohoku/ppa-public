...
もう一つの例として,実行例(1)の場合を考えよう.

| $i \setminus j$ | 0 | 1 | 2 | 3 | $x_i$ |
|:---------------:|:-:|:-:|:-:|:-:|:-----:|
|      **0**      | <font color="red">0</font> | 1 | 2 | 3 |       |
|      **1**      | <font color="red">1</font> | 1 | 2 | 2 |   e   |
|      **2**      | 2 | <font color="red">1</font> | 2 | 3 |   a   |
|      **3**      | 3 | 2 | <font color="red">1</font> | <font color="red">2</font> |   t   |
|      $y_j$      |   | a | t | e |       |
{: .table .table-striped}

+ 先ほどの例と同様にして,最小の経路は$c_{3,3} \rightarrow c_{3,2} \rightarrow c_{2,1} \rightarrow c_{1,0} \rightarrow c_{0,0}$と求まる.
+ また,当然ではあるが,$c_{3,3} \rightarrow c_{2,2} \rightarrow c_{1,1} \rightarrow c_{0,0}$の経路は許されない.

もう一つの例として,$X=range, Y=garage$の場合を考えよう.
