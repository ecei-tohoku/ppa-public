...
[Windows環境でプログラミングを行う手順](http://ecei-tohoku.github.io/ppa/docs/gcc_for_windows.html)や[Mac OS X環境でプログラミングを行う手順](http://ecei-tohoku.github.io/ppa/docs/gcc_for_osx.html)を参照して下さい．
