...
変数a,bを関数`func1`と関数`func2`で宣言したとする.
...
これらの二つの変数はそれぞれ,変数aは関数func1の中でのみ,変数bは関数func2の中でのみ利用することが可能な変数であり,変数bを関数func1で利用することは出来ず,変数aを関数func2で利用することもできない.次のように,両者を同じ名前で宣言したとしても二つのiは全くの別物である.
