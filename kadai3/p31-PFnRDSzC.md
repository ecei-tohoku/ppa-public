...
---
+ 二次元配列とは，インデックスが二つある配列のことを指し，`a[i][j]`のようにアクセスする配列である（数学でいう行列をイメージすればよい）．
+ C言語においては，固定長の二次元配列は`int a[3][4]`のように書くが，２番目のサイズを関数に明示的に指定しなければいけないため，非常に使い勝手が悪い（詳しくは。。。を参照）．
...
---
### 二次元配列<a name="2D_array"></a>
---

<img src="p31-2D-array.png" width="750px">
