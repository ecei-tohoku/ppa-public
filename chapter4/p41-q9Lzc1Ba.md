...
- <font color="red">**重要**</font> 削除（delete）と挿入（insert）の操作を無視しているので，ステップ1/3とステップ2/3で計算する編集距離は正しい編集距離ではないことに注意せよ.例として，eatとateの正しい編集距離は2であるが，ステップ1/3では先頭の文字から$x_1$と$y_1$，$x_2$と$y_2$，$x_3$と$y_3$の全ての文字が異なるので編集距離は3となる.
...
- ステップ2/3では引き続き，削除（delete）と挿入（insert）の操作は忘れて(正しくない)編集距離を計算する．
