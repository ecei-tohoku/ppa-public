...
編集距離$c_{i,j}$は$c_{i-1, j} + 1$によって得ることができ，このときの編集操作は削除（delete）に対応する．
何故かというと，二つの接頭辞$X_{i-1} = \langle x_1, x_2, ..., x_{i-1} \rangle$と$Y_j = \langle y_1, y_2, ..., y_j \rangle$の編集距離$c_{i-1, j}$の値がわかっているとき
